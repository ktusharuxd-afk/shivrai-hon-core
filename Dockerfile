...
CMD ["./build/bin/bitcoind", "-regtest", "-datadir=/root/.shivrai-hon", "-rpcuser=shivraiuser", "-rpcpassword=honpassword123", "-rpcallowip=0.0.0.0/0", "-rpcport=8332", "-server=1", "-daemon=0", "-txindex=1", "-bind=0.0.0.0"]
